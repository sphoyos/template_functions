...
sort `identifica' `tc'
htput <BR>
htput <H2> Análisis para la variable `varlab' </H2>
...
||  , title (Evolució Individual ) subtitle ( `varlab')  ysc(range(`min',`max'))  xlabel(0(1)2, valuelabel)  ylabel(#10)legend(label(1 "`lab0'") label(2 "`lab1'")) 
...
||, title (Evolució de la mediana `nloc' ) subtitle ( `varlab')   ysc(range(`min',`max'))   ylabel(#10)  xlabel(0(1)2, valuelabel)  ///
...
||, title (Evolució de la mitjana `nloc' ) subtitle ( `varlab')      ylabel(#10) xlabel(0(1)2, valuelabel) ///
